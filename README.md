...
$outputDir = "$env:USERPROFILE\Desktop\whisper-output"
...
如果出現 `Only the owner and editors can download this file`，代表檢視者被禁止下載。檔案擁有者需要在 Google Drive 分享設定中允許檢視者下載、列印或複製，否則 `gdown` 和本工具產生的指令都無法下載該檔案。
